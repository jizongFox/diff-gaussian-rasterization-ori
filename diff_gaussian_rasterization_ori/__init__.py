...
def rasterize_gaussians(
    ...
    assert str(means3D.device) == "cuda:0"
    assert str(means2D.device) == "cuda:0"
    assert str(sh.device) == "cuda:0"
    assert str(opacities.device) == "cuda:0"
    assert str(scales.device) == "cuda:0"
    assert str(rotations.device) == "cuda:0"
